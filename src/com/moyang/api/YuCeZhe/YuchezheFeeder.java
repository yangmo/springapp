...
public class YuchezheFeeder {
    ...
    static void printMissingStockIds(String date) {
		...
		for(int i = 1; i < lines.length; i++) {
			try {
			    ...
			    Set<String> allStockIds = StockNameUtil.getAllStockIds();
			    if(!allStockIds.contains(stockId)) {
			    	System.out.println("Missing " + stockId);
			    }
			} catch (Throwable t) {
